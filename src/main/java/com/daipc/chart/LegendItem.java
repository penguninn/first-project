...
public class LegendItem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblColor = new com.daipc.chart.LabelColor();

        lbName.setForeground(new java.awt.Color(100, 100, 100));
        lbName.setText("Name");

        lblColor.setBackground(new java.awt.Color(51, 51, 255));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblColor, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private com.daipc.chart.LabelColor lblColor;
