...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/daipc/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/daipc/icon/eye_hide.png")).getImage();
